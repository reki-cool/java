  ...
  <!--<![endif]-->
    ...
    <div class="sidebar-nav">
        ...
        <ul id="reader-menu" class="nav nav-list collapse in">
            ...
            <li class="active"><a href="${pageContext.request.contextPath }/AddUserAdminServlet">添加读者信息</a></li>
        </ul>
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title">添加读者信息</h1>
        </div>
        
                <ul class="breadcrumb">
            <li><a href="index.jsp">管理主页</a> <span class="divider">/</span></li>
            <li class="active">读者管理->添加读者信息
        </ul>
...
<div class="well">
    <ul class="nav nav-tabs" style="font-color:font-color:#000;">
      <li class="active" style="margin-left:0;"><a href="#addbook" data-toggle="tab">添加读者</a></li>
    </ul>
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="addbook">
        <form id="tab" action="${pageContext.request.contextPath }/RegisterServlet" method="post" onSubmit="return checkBlank()">
            <input id="aduser1" name="rdCardId" type="text"  class="input-xlarge" placeholder="借书证号" value="${user.rdCardId }">
            <input id="aduser2" name="rdPassword" type="text"  class="input-xlarge" placeholder="密码" value="${user.rdPassword }">
            <input id="aduser3" name="rdName" type="text"  class="input-xlarge" placeholder="姓名" value="${user.rdName }">
            <input name="rdSex" type="text"  class="input-xlarge" placeholder="性别" value="${user.rdSex }">
            <input id="aduser4" name="rdPhone" type="text"  class="input-xlarge" placeholder="手机号" value="${user.rdPhone }">
            <input id="aduser5" name="rdCardNo" type="text"  class="input-xlarge" placeholder="身份证号" value="${user.rdCardNo }">
            <input name="rdEmail" type="text"  class="input-xlarge" placeholder="邮箱" value="${user.rdEmail }">
            <input name="rdAddr" type="text"  class="input-xlarge" placeholder="家庭住址" value="${user.rdAddr }">
            <button type="submit" class="btn-success span12" style="margin-left:0;">添加读者</button>
        </form>
      </div>
  </div>
  ...
  <div class="modal-footer">
    ...
    <script type="text/javascript">
        ...
        function checkBlank() {  //判断添加书本时，书本信息是否为空或者不符合要求
        	...
        	var str = "";  //要输出显示的内容
        	for(var i = 1; i <=5; i++) {
        		var x = document.getElementById("aduser"+i.toString()).value;
        		if(x.trim() == "") {
        			count ++;
        			str += "丨"+document.getElementById("aduser"+i.toString()).placeholder  + "丨  ";
        			flag = true;
        		}
