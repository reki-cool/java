  ...
  <!--<![endif]-->
    ...
    <div class="sidebar-nav">
        ...
        <ul id="borrow-menu" class="nav nav-list collapse in">
            ...
            <li class="active"><a href="add_borrow.jsp">添加借阅信息</a></li>
        </ul>
    ...
    <div class="content">
        <div class="header">
            <h1 class="page-title">添加借阅信息</h1>
        </div>
                <ul class="breadcrumb">
            <li><a href="index.jsp">管理主页</a> <span class="divider">/</span></li>
            <li class="active">借阅管理->添加借阅信息
        </ul>
...
<div class="well">
    <ul class="nav nav-tabs" style="font-color:font-color:#000;">
      <li class="active" style="margin-left:0;"><a href="#addbook" data-toggle="tab">添加借阅</a></li>
    </ul>
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="addbook">
        <form id="tab">
            <input type="text"  class="input-xlarge" placeholder="借书证号">
            <input type="text"  class="input-xlarge" placeholder="读者姓名">
            <input type="text"  class="input-xlarge" placeholder="拟还时间">
            <input type="text"  class="input-xlarge" placeholder="书名">
            <button type="submit" class="btn-success span12" style="margin-left:0;">添加此借阅信息</button>
        </form>
      </div>
  </div>
