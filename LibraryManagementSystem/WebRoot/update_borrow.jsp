  ...
  <!--<![endif]-->
    ...
    <div class="sidebar-nav">
        ...
        <ul id="reader-menu" class="nav nav-list collapse in">
            <li class="active"><a href="${pageContext.request.contextPath }/FindAllUsersAdminServlet">总览读者列表</a></li>
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title">修改借阅信息</h1>
        </div>
        
                <ul class="breadcrumb">
            <li><a href="index.jsp">管理主页</a> <span class="divider">/</span></li>
            <li><a href="rud_borrow.jsp">借阅管理->查询删改借阅</a> <span class="divider">/</span></li>
            <li class="active">修改借阅信息
        </ul>
...
<div class="well">
    ...
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="addbook">
        <form id="tab">
            <input type="text"  class="input-xlarge" placeholder="图书编号">
            <input type="text"  class="input-xlarge" placeholder="图书书名">
            <input type="text"  class="input-xlarge" placeholder="图书作者">
            <input type="text"  class="input-xlarge" placeholder="作者简介">
            <input type="text"  class="input-xlarge" placeholder="出版社">
            <input type="text"  class="input-xlarge" placeholder="出版时间">
            <input type="text"  class="input-xlarge" placeholder="图书单价">
            <input type="text"  class="input-xlarge" placeholder="图书简介">
            <input type="text"  class="input-xlarge" placeholder="图书语种">
            <input type="text"  class="input-xlarge" placeholder="所属类别">
            <textarea rows="3" class="input-xlarge" placeholder="标签丨多个标签之间以英文逗号隔开"></textarea>
