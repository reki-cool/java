  ...
  <!--<![endif]-->
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <li><a href="rud_book.jsp">图书管理->查询删改图书</a> <span class="divider">/</span></li>
            <li class="active">修改图书信息
        </ul>
...
<div class="well">
    ...
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="addbook">
        <form id="tab" action="${pageContext.request.contextPath }/UpdateBookServlet" method="post">
            <input name="bkNum" type="text"  class="input-xlarge" placeholder="图书编号" value="<%=request.getParameter("bkNum") %>">
            <input name="bkName" type="text"  class="input-xlarge" placeholder="图书书名" value="<%=request.getParameter("bkName") %>">
            <input name="auName" type="text"  class="input-xlarge" placeholder="图书作者" value="<%=request.getParameter("auName") %>">
            <input name="auInfo" type="text"  class="input-xlarge" placeholder="作者简介" value="<%=request.getParameter("auInfo") %>">
            <input name="bkPub" type="text"  class="input-xlarge" placeholder="出版社" value="<%=request.getParameter("bkPub") %>">
            <input name="bkPubTime" type="text"  class="input-xlarge" placeholder="出版时间" value="<%=request.getParameter("bkPubTime") %>">
            <input name="bkPrice" type="text"  class="input-xlarge" placeholder="图书单价" value="<%=request.getParameter("bkPrice") %>">
            <input name="bkInfo" type="text"  class="input-xlarge" placeholder="图书简介" value="<%=request.getParameter("bkInfo") %>">
            <input name="bkLang" type="text"  class="input-xlarge" placeholder="图书语种" value="<%=request.getParameter("bkLang") %>">
            <input name="typeName" type="text"  class="input-xlarge" placeholder="所属类别" value="<%=request.getParameter("typeName") %>">
            <input name="bkInv" type="text"  class="input-xlarge" placeholder="库存" value="<%=request.getParameter("bkInv") %>">
            <input name="bkTag" type="text" class="input-xlarge" placeholder="标签丨多个标签之间以英文逗号隔开" value="<%=request.getParameter("bkTag") %>">
            <button type="submit" class="btn-success span12" style="margin-left:0;">更新图书</button>
        </form>
      </div>
  </div>
